    ...
    <View className="flex-1 w-full px-6 py-16 justify-between items-center relative bg-secondary">
      ...
      <View className='w-full gap-y-6'>
        <TouchableOpacity className="w-full h-16 px-6 flex flex-row justify-start items-center rounded-full bg-secondary-dark border-2 border-secondary-medium">
          ...
          <Text className="text-xl text-white ml-12"> Continue with Google </Text>
        </TouchableOpacity>
        <TouchableOpacity className="w-full h-16 px-6 flex flex-row justify-start items-center rounded-full  bg-secondary-dark border-2 border-secondary-medium">
          <Image source={require("../../assets/logoApple.png")} />
          <Text className="text-xl text-white ml-12"> Continue with Apple </Text>
        </TouchableOpacity>
        <TouchableOpacity className="w-full h-16 px-6 flex flex-row justify-start items-center rounded-full  bg-secondary-dark border-2 border-secondary-medium">
          <Image source={require("../../assets/logoFacebook.png")} />
          <Text className="text-xl text-white ml-12"> Continue with Facebook </Text>
        </TouchableOpacity>
        <TouchableOpacity className="w-full h-16 px-6 flex flex-row justify-start items-center rounded-full  bg-secondary-dark border-2 border-secondary-medium">
          <Image source={require("../../assets/logoTwitter.png")} />
          <Text className="text-xl text-white ml-12"> Continue with Twitter </Text>
        </TouchableOpacity>
      </View>
      <View className="gap-y-6">
        ...
        <View className="w-full flex flex-row gap-4 items-center justify-center">
          <TouchableOpacity
            className="bg-secondary-medium w-full h-16 flex justify-center items-center rounded-full"
          >
            <Text className="text-white font-medium text-lg text-center">Log in</Text>
          </TouchableOpacity>
        </View>
      </View>
